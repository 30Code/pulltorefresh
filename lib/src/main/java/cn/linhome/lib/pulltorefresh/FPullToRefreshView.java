...
import cn.linhome.lib.gesture.FGestureManager;
import cn.linhome.lib.gesture.FScroller;
...
public class FPullToRefreshView extends BasePullToRefreshView
{
    ...
    private boolean canPull()
    {
        ...
        final boolean checkState = getState() == PullToRefreshView.State.RESET;
    ...
    private boolean canPullFromHeader()
    {
        ...
        final boolean checkMode = getMode() == PullToRefreshView.Mode.PULL_BOTH || getMode() == PullToRefreshView.Mode.PULL_FROM_HEADER;
    ...
    private boolean canPullFromFooter()
    {
        ...
        final boolean checkMode = getMode() == PullToRefreshView.Mode.PULL_BOTH || getMode() == PullToRefreshView.Mode.PULL_FROM_FOOTER;
